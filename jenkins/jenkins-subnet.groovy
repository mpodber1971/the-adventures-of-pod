...
class JenkinsMasters {
    def DEFAULT_OPTION = 'WebDigital-Private-PL-1a'
    def PULL_DOWN_VALUE_NOT_SELECTED = '< --'
    def SELECTED_INDICATOR = ':selected'

    // All valid magento github orgs
    def aJenkinsMasters = ['WebDigital-Private-PL-1a',
                           'WebDigital-Private-PL-1b',
                           'WebDigital-Private-PL-1c',
                           'WebDigital-Private-PL-1d']
